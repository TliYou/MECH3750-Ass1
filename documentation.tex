...
(0.99, 0.95, 0.9, 0.5). To prevent errors, the limits of the bisection method
were set to be between 0.01 and 0.99$\pi$ instead of 0 to $\pi$ for $\alpha$.
\clearpage

The values of 4 variables are shown below, where $\frac{x_g}{L}$ is the control
variable. The code is provided on the following page.
\\
